...
var controller = {
	...
	save: function (req, res){
		...
		if(validate_name && validate_surname && validate_email && validate_password){
			...
			User.findOne({email: user.email}, (err, issetUser) =>{
				...
				if(!issetUser){
					//Si no existe, cifrar contraseña y guardarlo
	...
	update: function(req, res){
		...
		// 0. Crear el middleware para comprobar el jwt token, ponerselo a la ruta (Listo)
	...
	uploadAvatar: function(req, res){
		...
		//Configurar el modulo multiparty (md) se hizo en routes/user.js
		...
		//Comprobar extension (Solo imagines), si no es validad borrar fichero subido
